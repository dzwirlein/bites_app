...
class HomeBody extends Component {
    ...
    render() {
       ...
       return(        
            ...
            <div>
                <ResultsModal
                    onClose={ this.showResultsModal }
                    show={this.state.show}>
                    <h1>This message is from Modal</h1>    
                </ResultsModal> />
            
                <div className="jumbotron jumbotron-fluid mb-0 pb-0">
                    <div className="dark-overlay">
                        <div className="jumbo-inner container">
                            ...
                            <div className="row" id="arrow-div">
                                {/* Temporary Modal Button. Remove in final layout */}
                                <div className="nav-item mr-5"
                                    type="button"
                                    onClick={this.showResultsModal}
                                    value="Show Results Modal">
                                    <a className="btn" id="modal-btn" href="#" >
                                        <h5 className="my-auto" id="modal-btn-text">Modal</h5>
                                    </a>
                                </div>
                                {/* END MODAL BUTTON */}
